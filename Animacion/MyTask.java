public class MyTask {
    ...
    public MyTask() {
        ...
        this.animationModel = new AnimationModel(AnimationStatus.running,3,6);
    ...
    public static void main(String[] args) {
        ...
        AnimationModel animationModel = new AnimationModel(AnimationStatus.running,4,6);
        ...
        Thread modelTread =new Thread(animationModel);
        modelTread.start();
        
       
        Thread viewTread =new Thread(animationView);
        viewTread.start();
